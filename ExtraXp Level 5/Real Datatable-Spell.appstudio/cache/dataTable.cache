...
btnAdd.onclick=function(){
  NSB.MsgBox('Danielle Spell was added. Search the table to see values.')
}

//adding my data
dataTable.onshow=function(){
  data1.push(["Danielle Spell", "CEO", "New York", "1234", "2020/10/20", "$222,000"])
  data1.push(["Matthew Spell", "CIO", "Peoria", "1235", "1999/11/25", "$325,000,000"])
  data1.push(["Billy Spell", "Pianist", "Chicago", "1236", "2000/01/22", "$199,000,540"])
  NSB.MsgBox('Danielle Spell & Matthew Spell were added. Search table to their see values.')
}
