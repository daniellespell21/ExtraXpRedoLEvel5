...
const cacheName = 'Real_extraxplevel5-2020-11-10 11:51:51.622568'; // unique value, generated each deploy
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, 'Real_extraxplevel5'.length) === 'Real_extraxplevel5') {
